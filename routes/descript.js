...
/*
get all submission of this user authenticated from codeforces api.
parse it into json
check from database for the user and update his verdicts for a problem (wrong to correct) or add new problem solved to the database.
